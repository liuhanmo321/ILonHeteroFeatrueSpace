...
class SAINT(nn.Module):
    def __init__(
        ...
        *,
        ...
        self.specific_classifier = nn.ModuleList([simple_MLP([2 * dim , self.hidden_dim, y_dim])])
    ...
    def add_task(self, categories, num_continuous, y_dim):
        ...
        self.specific_classifier.append(simple_MLP([2 * self.dim , self.hidden_dim, y_dim]))
